...
const Physics = (entities, { time }) => {
  if (da && entities.chicken1) {
    ...
    Matter.Composite.add(wrld1, entities.chicken2.body);
    ...
    Matter.Composite.add(wrld1, entities.chicken3.body);
    ...
    Matter.Composite.add(wrld1, entities.chicken4.body);


  
   // let elevation =entities.pillar.HEIGHT- entities.pillar.WIDTH/4;
 ...
 //  Matter.Composite.add(wrld1, entities.plank.body);
...
//    Matter.Composite.add(wrld1, entities.bolt.body);
    ...
    Matter.Composite.add(wrld1, ground);
