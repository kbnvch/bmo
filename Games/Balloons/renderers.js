...
class ZupaColla extends PureComponent {

  render() {
    let collaImg = this.props.collaImg;
    const WIDTH = this.props.WIDTH;
    const HEIGHT = this.props.HEIGHT;
    return (
      <Image source={collaImg} style={[styles.rect, {left:(WIDTH-WIDTH*0.6)*0.5,top:(WIDTH-WIDTH*0.6)*0.5, width: WIDTH*0.6, height: WIDTH*0.6 }]} />
